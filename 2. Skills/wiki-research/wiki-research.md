...
El material consultat es conserva a `0. Raw/`. Les fitxes permanents només es creen o actualitzen després de comparar-les amb el contingut existent.
...
1. un dossier a `0. Raw/` amb l’abast, les rondes, les fonts i les conclusions;
